...
parser.add_argument("--cla-window", type=int, default=-1, help="no sliding window by default")
...
while True:
    ...
    if args.eval_every > 0 and step > 0 and (last_step or step % args.eval_every == 0):
        model.eval()
